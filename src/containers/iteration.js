...
class IterationEdit extends React.Component {
  constructor() {
    super()
    this.state = {
      project: {},
...
const mapDispatchtoProps = dispatch => ({
  setWorkIds: (iteration) => dispatch({type: 'Iterations', iteration })
})
export default connect(mapStateToProps)(IterationEdit)